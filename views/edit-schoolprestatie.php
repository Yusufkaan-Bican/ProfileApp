            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            $student_id = $_GET['id'];
                            $query = "SELECT * FROM schoolprestatie WHERE id = :student_id";
                        ...
                        ?>
                                <form action="crud.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label>Diploma</label>
                                        <input type="text" name="diploma" value="<?= $student['diploma']; ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Cijfer</label>
                                        <input type="text" name="cijfer" value="<?= $student['cijfer']; ?>" class="form-control">
                                    </div>
                                    <div class="mb-3"></BR>
